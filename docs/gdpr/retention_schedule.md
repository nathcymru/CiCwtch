...
| Behavior snapshots | D1 `behavior_snapshots` | cascade delete on dog | retained while the parent dog record is active; deleted automatically when the dog is hard-deleted; no independent soft-delete endpoint |
