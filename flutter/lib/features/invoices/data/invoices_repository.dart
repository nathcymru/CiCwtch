...
class InvoicesRepository {
  ...
  Future<List<InvoiceHeader>> listInvoices() async {
    final json = await _api.get('/api/v1/invoices') as List<dynamic>;
    return json
  ...
  Future<InvoiceHeader> getInvoice(String id) async {
    final json =
        await _api.get('/api/v1/invoices/$id') as Map<String, dynamic>;
    return InvoiceHeader.fromJson(json);
  }

  Future<InvoiceHeader> createInvoice(Map<String, dynamic> payload) async {
    final json = await _api.post('/api/v1/invoices', payload)
  ...
  Future<InvoiceHeader> updateInvoice(
    ...
    final json = await _api.put('/api/v1/invoices/$id', payload)
        as Map<String, dynamic>;
    return InvoiceHeader.fromJson(json);
  }

  Future<void> deleteInvoice(String id) async {
    await _api.delete('/api/v1/invoices/$id');
  }
}
